...
%   VSCL = VSCALE(F) returns the vertical scale of a ballfun object F as
...
% If f is an empty ballfun, VSCL = 0: 
if ( isempty(f) ) 
    vscl = 0; 
    return
end
...
elseif ( isa(tech(), 'trigtech') )
    ...
    error('CHEBFUN:ballfun:vscale:mypoints:techType', ...
