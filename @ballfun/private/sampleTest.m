...
%SAMPLETEST   Test an evaluation of input OP against a ballfun.
%
%   SAMPLETEST(F, SAMPLEOP, TOL) evaluates both the function SAMPLEOP and 
%   its ballfun representation F at several points in it's domain. The 
...
% scale [0,1]^3 to the domain of the ballfuns.
x = H(:,1); 
