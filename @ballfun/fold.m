...
%   Example 1:
%   A = randn(15, 8);
%   T = ballfun.fold(A, [2 3 4 5], [2 4]) % returns a 2x3x4x5 tensor
%   
%   Example 2: 
%   T = rand(m,n,p);
%   T2 = ballfun.unfold(T, 2); % Mode-2 unfolding of T
%
%   Here is the reverse operation:
%   T_new = ballfun.fold(T2, [m, n, p], 2, [1 3]);
%
% See also ballfun/UNFOLD.
