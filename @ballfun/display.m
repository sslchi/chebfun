function display(F)
%DISPLAY    Display information about a ballfun.
%   DISPLAY(F) outputs information about the ballfun F to the 
...
%   a statement that results in a ballfun.
%
% See also ballfun/DISP.
